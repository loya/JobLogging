...
namespace JobLogging.Forms
{
    public partial class FrmJobLogging : DevExpress.XtraEditors.XtraForm
    {
        ...
        public FrmJobLogging()
        {
            ...
            userBindingSource.DataSource = Context.Users;
        ...
        private void btnGridViewRefresh_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            Context.Refresh(System.Data.Objects.RefreshMode.StoreWins, Context.JobOrders);
